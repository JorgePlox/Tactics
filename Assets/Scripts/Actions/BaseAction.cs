...
public abstract class BaseAction : MonoBehaviour
{
    ...
    {
        List<GridPosition> validListPositionList = GetvalidActionsGridPositionList();
        return validListPositionList.Contains(gridPosition);
    }
    ...
    public EnemyAIAction GetBestEnemyAIAction()
    {
        ...
        List<GridPosition> validActionGridPosition = GetvalidActionsGridPositionList();
